class StudentGroupsController < ApplicationController
  ...
  def index
    ...
    @institutes=@facilitator.institutes
    @student_groups=@institutes.collect{|inst|inst.student_groups}
  ...
  def new
    ...
    @facilitator=Facilitator.find_by_user_id(current_user.id)
    @institutes=@facilitator.institutes.collect{|institute|[institute.name,institute.id]}
